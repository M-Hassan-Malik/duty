...
class _OffersState extends State<Offers> {
  ...
  Widget build(BuildContext context) {
    print(widget.details['status'].toString());
    final offers = widget.details['doc']['offers'];
    var jsonResponse;
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              widget.details['status'] == 0
                                  ? Visibility(
                                      visible: UserStorage.currentUserId == widget.details['doc']['uid'],
                                      child: InkWell(
                                        onTap: () async {
                                          (showDialog(
                                              context: context,
                                                          ...
                                                          jsonResponse =
                                                              await http.post(Uri.parse('$API_URL/duty/assignDuty'),
                                                                  ...
                                                                  body: convert.jsonEncode({
                                                                    ...
                                                                    "city": widget.details['doc']['duty']['city'],
                                                                    "country": widget.details['doc']['duty']['country'],
